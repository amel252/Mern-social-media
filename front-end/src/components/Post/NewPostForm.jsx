...
const NewPostForm = () => {
    ...
    const handlePicture = (e) => {
        ...
        // pour l'envoyer la BD
        setFile(e.target.files[0]);
        // l'un annule l'autre on ne peut pas avoir les 2 video ou image
        setVideo("");
    };
                ...
                <>
                    <div className="data">
                        ...
                        <p>
                            <span>
                                {userData.followers
                                    ? userData.followers.lenght
                                    : 0}
                            </span>
                            {""}
                            Abonné
                            {userData.follower && userData.followers.lenght > 1
                                ? "s"
                                : null}
                        </p>
                    </div>
